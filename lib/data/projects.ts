...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A full-stack vocabulary learning platform for Grade 10 students, combining video lessons, quizzes, three themed learning games, and real-time progress tracking. VoDeMe turns synonyms, collocations, roots, prefixes, and suffixes into a structured, gamified experience with secure Google OAuth and database-backed learner progress.",
    images: [
      { src: "/images/vodeme/vodeme-1.png", label: "Landing Page" },
      { src: "/images/vodeme/vodeme-2.png", label: "Sign-In & Google OAuth" },
      { src: "/images/vodeme/vodeme-3.png", label: "Learner Dashboard & Game Library" },
      { src: "/images/vodeme/vodeme-4.png", label: "Video Lessons" },
      { src: "/images/vodeme/vodeme-5.png", label: "Interactive Lesson Player" },
      { src: "/images/vodeme/vodeme-6.png", label: "SynoHit — How to Play" },
      { src: "/images/vodeme/vodeme-7.png", label: "SynoHit — Level Progression" },
      { src: "/images/vodeme/vodeme-8.png", label: "SynoHit — Live Challenge" },
    ],
    tech: [
      "Next.js 16",
      "React 19",
    ...
    features: [
      "Three multi-level vocabulary games: SynoHit, HopRight, and Word Study Journal",
      "Video lessons and gated quizzes for synonyms, collocations, and word formation",
      "Daily vocabulary cards with definitions, examples, synonyms, and antonyms",
      "Persistent points, lesson completion, quiz results, game progress, and leaderboard ranking",
      "Google OAuth plus secure email/password authentication with database-backed sessions",
      "Learner profiles with image uploads and account management",
      "Post-lesson Learning Wall reflections with community likes",
